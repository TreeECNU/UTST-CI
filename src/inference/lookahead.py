...
class Lookahead:
    ...
    def __init__(
        ...
        stopping_criteria_generation_config = GenerationConfig(
        ...
        self.stopping_criteria = self.model._get_stopping_criteria(
            ...
            generation_config=stopping_criteria_generation_config,
        )

        logits_warper_generation_config = GenerationConfig(
            top_k=top_k,
            top_p=top_p,
            typical_p=typical_p,
        ...
        self.logits_warper = self.model._get_logits_warper(
            generation_config=logits_warper_generation_config,
        )
