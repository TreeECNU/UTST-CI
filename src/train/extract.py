...
if __name__ == "__main__":
    input_file = "data/validation_prompt_score.json"  # 你的输入文件
    output_file = "data/validation_prompt_score_01.json"    # 输出文件
    extract_by_ratio_jsonl(input_file, output_file, 0.1)  # 提取10%